...
const BEHAVIORAL_VOLUME_SPIKE_ALERT = "behavioral-volume-spike-alert"
const VC_NO_REDUCTION_ALERT = "vc-no-reduction-alert"
const DEPLOYMENT_DELAY_ALERT = "deployment-delay-alert"
const EVENT_FLOW_MONITORING = "event-flow-monitoring"
...
const S3_PARQUET_SCHEMA_SYNC = "s3-parquet-schema-sync"
const SEARCH_EXPORT_PROCESSOR = "search_export_processor"
const IMPORT_REQUEST_PROCESSOR = "import_request_processor"
const CREDENTIAL_EXPIRY_NOTIFICATION = "credential-expiry-notification"
