...
func getQueryFromConfig(ctx context.Context, req models.AuditReport, failedRequests *[]models.FailedRequests) (string, error) {
	...
	otherParamsAdded, query = updateQueryFromFilter(configData, otherParamsAdded, query, "destinationType", "destination_type")
	otherParamsAdded, query = updateQueryFromFilter(configData, otherParamsAdded, query, "forwardDataType", "forward_data_type")
